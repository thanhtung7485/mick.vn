...
namespace EagleDigital.CodeFirst.TenantDevelopment.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<EagleDigital.CodeFirst.TenantDevelopment.MickContext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = false;
            MigrationsDirectory = @"TenantDevelopment\Migrations";
        }

        protected override void Seed(EagleDigital.CodeFirst.TenantDevelopment.MickContext context)
        {
